...
export default function RefundPolicy() {
  ...
  const sections: LegalSection[] = isEs
    ? [
        ...
        { heading: "2. Derecho de desistimiento (UE / EEE / Reino Unido)", items: [
        ...
        { heading: "3. Suscripciones (Nivel 1, Nivel 2, Premium)", items: [
        ...
        { heading: "4. Paquetes de créditos", items: [
        ...
        { heading: "5. Regalos virtuales", items: [
        ...
        { heading: "6. Regalos físicos (cuando estén disponibles)", items: [
        ...
        { heading: "7. Cobros duplicados, errores y fraude", items: [
        ...
        { heading: "8. Cuentas suspendidas o cerradas por violación", items: [
        ...
        { heading: "9. Cómo solicitar un reembolso", items: [
        ...
        { heading: "11. Cambios a esta Política", items: [
