...
export default function CommunityGuidelines() {
  ...
  const sections: LegalSection[] = isEs
    ? [
        { heading: "1. Sé tú mismo (autenticidad)", items: [
        ...
        { heading: "2. Trata a los demás con respeto", items: [
        ...
        { heading: "3. Intenciones serias, no entretenimiento", items: [
        ...
        { heading: "4. Cero tolerancia a la solicitación y al fraude", items: [
        ...
        { heading: "5. Protege a los menores", items: [
        ...
        { heading: "6. Contenido permitido y no permitido", items: [
        ...
        { heading: "7. Privacidad de los demás", items: [
        ...
        { heading: "8. Verificación y confianza", items: [
        ...
        { heading: "9. Seguridad al conocerse en persona", items: [
        ...
        { heading: "10. Mensajes, regalos y créditos", items: [
        ...
        { heading: "11. Política de denuncias", items: [
        ...
        { heading: "12. Aplicación y consecuencias", items: [
        ...
        { heading: "14. Cómo contactarnos", items: [
    ...
    : [
        { heading: "1. Be yourself (authenticity)", items: [
        ...
        { heading: "2. Treat others with respect", items: [
        ...
        { heading: "3. Serious intentions, not entertainment", items: [
        ...
        { heading: "4. Zero tolerance for solicitation and fraud", items: [
        ...
        { heading: "5. Protect minors", items: [
        ...
        { heading: "6. What you can and cannot post", items: [
        ...
        { heading: "7. Other people's privacy", items: [
        ...
        { heading: "8. Verification and trust", items: [
        ...
        { heading: "9. Safety when meeting in person", items: [
        ...
        { heading: "10. Messages, gifts and credits", items: [
        ...
        { heading: "11. Reporting policy", items: [
        ...
        { heading: "12. Enforcement and consequences", items: [
        ...
        { heading: "14. How to contact us", items: [
