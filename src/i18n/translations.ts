    ...
    legal: {
      ...
      tosSections: [
        ...
        { heading: "15. Dispute resolution, arbitration and class-action waiver", items: [
          "Informal resolution first: before filing any formal claim, you agree to contact legal@matchvenezuelan.com with a written description of the dispute (your name, account email, the conduct or charge in dispute, the relief sought, and your contact details) and to attempt in good faith to resolve it for at least 60 days. Many disputes can be resolved at this stage and this step is a precondition to arbitration or court proceedings, except for matters within the 'Exceptions' paragraph below or where mandatory local consumer law allows you to skip it.",
          "Binding individual arbitration: where permitted by law, any unresolved dispute, claim or controversy arising out of or related to these Terms, our policies, the service, the content, advertising, marketing or the relationship between you and MatchVenezuelan (including pre-contractual claims) shall be resolved by final and binding individual arbitration administered by a recognized arbitral institution in the jurisdiction where MatchVenezuelan is incorporated, applying that institution's rules in force at the time of filing.",
          "Arbitrator, seat, language and costs: arbitration will be conducted by a single neutral arbitrator. The seat of arbitration will be the jurisdiction where MatchVenezuelan is incorporated; hearings may be held remotely. Proceedings will be in English, or in your local language at your request, with reasonable translation costs to be borne as the arbitrator decides under the applicable rules. Filing, administration and arbitrator fees will be allocated as provided by the institution's rules; for consumer claims under USD 10,000, MatchVenezuelan will pay all such fees in excess of the equivalent court filing fee, except where the claim is found by the arbitrator to be frivolous.",
          "Authority of the arbitrator: the arbitrator has exclusive authority to decide all issues, including the scope, enforceability and arbitrability of this clause, except that the enforceability of the class-action waiver is for a court of competent jurisdiction. The arbitrator may grant any relief a court could grant on an individual basis, but may not order class, collective or representative relief.",
          "Class-action, mass-arbitration and jury waiver: TO THE MAXIMUM EXTENT PERMITTED BY LAW, YOU AND MATCHVENEZUELAN AGREE TO BRING CLAIMS ONLY IN AN INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS, COLLECTIVE, CONSOLIDATED, MASS-ARBITRATION OR REPRESENTATIVE PROCEEDING, AND BOTH PARTIES WAIVE ANY RIGHT TO A JURY TRIAL. If a court holds the class-action waiver unenforceable as to a particular claim or remedy, that claim or remedy (and only that claim or remedy) is severed from arbitration and may proceed in a court of competent jurisdiction; all other claims continue in arbitration.",
          "30-day arbitration opt-out: you may opt out of this arbitration agreement by sending a signed written notice to legal@matchvenezuelan.com within 30 days of first accepting these Terms (or first accepting an updated version that materially changes this section), stating your name, account email and clear intent to opt out. Opting out does not affect any other part of these Terms.",
          "Exceptions: either party may always bring (i) an individual claim in a small-claims court of competent jurisdiction for claims within that court's monetary limits, or (ii) an action in court for injunctive or equitable relief in respect of intellectual property infringement, unauthorized access to the service, breach of confidentiality or violation of the Anti-Solicitation Policy.",
          "Consumer rights preserved: if you are a consumer in the EU/UK, Switzerland, Mexico, Brazil or another jurisdiction whose mandatory law gives you the right to bring proceedings in your local courts, to opt out of pre-dispute arbitration, or to participate in collective consumer redress mechanisms, those rights are not affected by this section. EU consumers may also use the European Commission's Online Dispute Resolution platform at https://ec.europa.eu/consumers/odr; UK consumers retain rights under the Consumer Rights Act 2015 and may use approved Alternative Dispute Resolution providers.",
          "Time to file: any claim must be filed within one (1) year after the cause of action arose, except where a longer period is required by mandatory consumer-protection law in your country of residence.",
          "Severability of this section: if any portion of this section 15 (other than the class-action waiver, which is governed by its own carve-out above) is held invalid or unenforceable, the remainder of this section shall remain in full force and effect.",
        ]},
        { heading: "16. Governing law, venue and export controls", items: [
          "Governing law: these Terms and any non-contractual obligations arising out of or in connection with them are governed by the laws of the jurisdiction where MatchVenezuelan is incorporated, excluding its conflict-of-laws rules and the UN Convention on Contracts for the International Sale of Goods. Mandatory consumer-protection laws of your country of residence continue to apply and prevail to the extent they grant you broader protection.",
          "Venue: subject to the arbitration clause, to mandatory consumer rights and to the EU/UK pathways described below, the courts of the jurisdiction where MatchVenezuelan is incorporated have exclusive jurisdiction over any dispute that is not subject to arbitration. Consumers domiciled in the EU, EEA, UK or Switzerland may bring proceedings in the courts of their country of domicile and may be sued by us only in those same courts, in line with Brussels I-bis (Regulation (EU) 1215/2012), the Lugano Convention and the UK retained equivalents.",
          "Export controls and sanctions: you agree to comply with all applicable export-control, sanctions and anti-money-laundering laws, including those of the United States (OFAC), the European Union, the United Kingdom (OFSI) and the United Nations, and you represent that you are not located in, ordinarily resident in, owned or controlled by, or otherwise subject to comprehensive sanctions; that you are not on any restricted-party list; and that you will not use the service to facilitate any transaction prohibited by those laws.",
        ]},
        { heading: "17. EU / UK consumer rights, DSA notice-and-action and trusted-flagger pathways", items: [
          "Mandatory consumer protections (EU/EEA/UK): nothing in these Terms limits the mandatory rights you have as a consumer under EU Directive 2011/83 on consumer rights, EU Directive 2019/770 on digital content and digital services, EU Directive 93/13 on unfair terms in consumer contracts, the UK Consumer Rights Act 2015 and equivalent national implementing laws. Where any provision of these Terms conflicts with such mandatory rights, that provision is read down to the minimum extent necessary and the mandatory rights prevail.",
          "Right of withdrawal (14 days): EU/EEA/UK consumers have a 14-day right of withdrawal from digital-services contracts. Because the service starts immediately after purchase, you are asked to expressly acknowledge that the digital service begins at once and that you lose the right of withdrawal over the portion already consumed (messages sent, contacts initiated, gifts delivered, credits spent, verification performed). Full details are set out in the Refund Policy.",
          "Statement of reasons (Article 17 DSA): when we restrict the visibility, demote, suspend or terminate any specific item of your content, your monetization, your account or your access to specific features, we will provide you, where required by Article 17 of Regulation (EU) 2022/2065 (the Digital Services Act, 'DSA'), with a clear and specific statement of reasons including the facts and circumstances relied on, any automated means used in the decision, the legal or contractual ground, and the redress options available to you.",
          "Notice and action mechanism (Article 16 DSA): any person or entity may notify us of content available on the service that they consider illegal under EU or national law, by writing to dsa-notice@matchvenezuelan.com. To enable us to act diligently, your notice should include: (i) a sufficiently substantiated explanation of why you consider the content illegal; (ii) a clear indication of the exact electronic location (URL/profile/message ID) of the content; (iii) your name and email (except for content concerning offences referred to in Articles 3–7 of Directive 2011/93, where anonymity is preserved); and (iv) a statement that the information in the notice is, to your best belief, accurate and complete. We will acknowledge receipt without undue delay and inform you of our decision and the available redress.",
          "Internal complaint-handling system (Article 20 DSA): if you disagree with a moderation decision affecting your content, account, monetization or access (or with our decision on a notice you submitted), you may submit a free internal appeal within six (6) months of the decision by writing to appeals@matchvenezuelan.com. A person who did not take the original decision will review your appeal and we aim to decide within a reasonable period.",
          "Out-of-court dispute settlement (Article 21 DSA): EU recipients of the service may also choose any out-of-court dispute settlement body certified by the Digital Services Coordinator of their Member State to resolve disputes about our moderation decisions. Engaging such a body does not affect your right to bring proceedings in court at any time.",
          "Trusted flaggers (Article 22 DSA): notices submitted by entities awarded 'trusted flagger' status by the Digital Services Coordinator of their Member State will be processed and decided with priority and without undue delay.",
          "Online Dispute Resolution (EU): EU consumers may use the European Commission's ODR platform at https://ec.europa.eu/consumers/odr to attempt out-of-court resolution of disputes about online services. Our contact email for ODR is legal@matchvenezuelan.com.",
          "UK redress: UK consumers retain rights under the Consumer Rights Act 2015, may complain to the Competition and Markets Authority (CMA) where applicable, and may use approved Alternative Dispute Resolution providers; nothing in these Terms removes statutory remedies under UK law.",
          "Single Point of Contact and legal representative: in line with Articles 11, 12 and 13 of the DSA we maintain a single point of contact for authorities and recipients of the service at dsa-contact@matchvenezuelan.com (working languages: English, Spanish). If we are not established in the EU, our designated EU legal representative for DSA purposes will be identified on this page once appointed.",
          "Transparency: we publish, where and to the extent required, transparency information on our content-moderation activities (volumes of notices received, actions taken, average response times, use of automated tools and human review).",
        ]},
        { heading: "18. Force majeure", items: [
        ...
        { heading: "19. Modification of the service and these Terms", items: [
        ...
        { heading: "20. Assignment, severability, entire agreement, no waiver", items: [
        ...
        { heading: "21. Contact", items: [
          "General legal: legal@matchvenezuelan.com · DSA contact / single point of contact: dsa-contact@matchvenezuelan.com · DSA notice and action: dsa-notice@matchvenezuelan.com · Appeals: appeals@matchvenezuelan.com · Privacy: privacy@matchvenezuelan.com · Trust & safety: trust@matchvenezuelan.com · Copyright/DMCA: copyright@matchvenezuelan.com · Security: security@matchvenezuelan.com.",
        ]},
      ],
      privacySections: [
    ...
    legal: {
      ...
      tosSections: [
        ...
        { heading: "15. Resolución de disputas, arbitraje y renuncia a acciones colectivas", items: [
          "Resolución informal previa: antes de presentar cualquier reclamación formal, aceptas contactar a legal@matchvenezuelan.com con una descripción escrita de la disputa (tu nombre, correo de la cuenta, la conducta o cargo en disputa, la reparación solicitada y tus datos de contacto) e intentar de buena fe resolverla durante al menos 60 días. Muchas disputas se resuelven en esta fase y este paso es condición previa al arbitraje o a un proceso judicial, salvo en los supuestos del párrafo de 'Excepciones' o cuando la legislación de consumo imperativa de tu país te permita omitirlo.",
          "Arbitraje individual vinculante: cuando la ley lo permita, cualquier disputa, reclamación o controversia no resuelta que surja de o se relacione con estos Términos, nuestras políticas, el servicio, el contenido, la publicidad, el marketing o la relación entre tú y MatchVenezuelan (incluidas reclamaciones precontractuales) se resolverá mediante arbitraje individual final y vinculante administrado por una institución arbitral reconocida en la jurisdicción donde MatchVenezuelan está constituida, aplicando el reglamento vigente de dicha institución al momento de la presentación.",
          "Árbitro, sede, idioma y costos: el arbitraje se llevará a cabo ante un único árbitro neutral. La sede del arbitraje será la jurisdicción donde MatchVenezuelan está constituida; las audiencias podrán celebrarse de forma remota. El procedimiento será en inglés o, a tu solicitud, en tu idioma local, asumiéndose los costos razonables de traducción según decida el árbitro conforme al reglamento aplicable. Las tasas de presentación, administración y honorarios del árbitro se asignarán conforme al reglamento institucional; para reclamaciones de consumidores por menos de USD 10.000, MatchVenezuelan pagará todas esas tasas que excedan la tasa equivalente de presentación judicial, salvo cuando el árbitro determine que la reclamación es frívola.",
          "Autoridad del árbitro: el árbitro tiene autoridad exclusiva para decidir todas las cuestiones, incluido el alcance, la exigibilidad y la arbitrabilidad de esta cláusula, salvo que la exigibilidad de la renuncia a acciones colectivas corresponde a un tribunal con jurisdicción competente. El árbitro puede otorgar cualquier reparación que un tribunal pudiera otorgar a título individual, pero no puede ordenar reparaciones colectivas, agregadas ni representativas.",
          "Renuncia a acciones colectivas, arbitraje masivo y juicio por jurado: EN LA MÁXIMA MEDIDA PERMITIDA POR LA LEY, TÚ Y MATCHVENEZUELAN ACEPTAN PRESENTAR RECLAMACIONES SOLO A TÍTULO INDIVIDUAL Y NO COMO DEMANDANTE O MIEMBRO DE CLASE EN NINGÚN PROCEDIMIENTO COLECTIVO, CONSOLIDADO, DE ARBITRAJE MASIVO O REPRESENTATIVO, Y AMBAS PARTES RENUNCIAN A CUALQUIER DERECHO A JUICIO POR JURADO. Si un tribunal declara inejecutable la renuncia a acciones colectivas respecto de una reclamación o reparación particular, esa reclamación o reparación (y solo ella) se separará del arbitraje y podrá tramitarse ante un tribunal con jurisdicción competente; las demás reclamaciones continuarán en arbitraje.",
          "Opción de exclusión de 30 días: puedes excluirte de este acuerdo de arbitraje enviando un aviso escrito firmado a legal@matchvenezuelan.com dentro de los 30 días siguientes a tu primera aceptación de estos Términos (o de una versión actualizada que modifique materialmente esta sección), indicando tu nombre, correo de la cuenta y voluntad clara de excluirte. La exclusión no afecta a las demás partes de estos Términos.",
          "Excepciones: cualquiera de las partes podrá siempre presentar (i) una reclamación individual ante un tribunal de menor cuantía con jurisdicción competente para asuntos dentro de sus límites monetarios, o (ii) una acción judicial para medidas cautelares o equitativas relacionadas con propiedad intelectual, acceso no autorizado al servicio, violación de confidencialidad o incumplimiento de la Política Anti-Solicitación.",
          "Derechos de consumidor preservados: si eres consumidor en la UE/Reino Unido, Suiza, México, Brasil u otra jurisdicción cuya ley imperativa te otorgue el derecho a entablar procedimientos en tus tribunales locales, a optar por no participar en arbitraje previo a la disputa o a participar en mecanismos colectivos de resolución de consumo, esos derechos no se ven afectados por esta sección. Los consumidores de la UE también pueden usar la plataforma de Resolución de Litigios en Línea de la Comisión Europea en https://ec.europa.eu/consumers/odr; los consumidores del Reino Unido conservan los derechos de la Consumer Rights Act 2015 y pueden recurrir a proveedores aprobados de Resolución Alternativa de Disputas (ADR).",
          "Plazo para presentar: cualquier reclamación deberá presentarse dentro del plazo de un (1) año desde que surgió la causa de pedir, salvo que la legislación de consumo imperativa de tu país de residencia exija un plazo más amplio.",
          "Divisibilidad de esta sección: si alguna parte de esta sección 15 (excluida la renuncia a acciones colectivas, regida por su propio párrafo) se declara inválida o inejecutable, el resto de esta sección permanecerá en pleno vigor.",
        ]},
        { heading: "16. Ley aplicable, foro y controles de exportación", items: [
          "Ley aplicable: estos Términos y cualquier obligación no contractual derivada o relacionada con ellos se rigen por las leyes de la jurisdicción donde MatchVenezuelan está constituida, excluyendo sus normas de conflicto de leyes y la Convención de la ONU sobre Contratos de Compraventa Internacional de Mercaderías. Las leyes imperativas de protección al consumidor de tu país de residencia siguen aplicándose y prevalecen en la medida en que te otorguen mayor protección.",
          "Foro: sujeto a la cláusula de arbitraje, a los derechos imperativos del consumidor y a las vías UE/Reino Unido descritas más abajo, los tribunales de la jurisdicción donde MatchVenezuelan está constituida tienen competencia exclusiva sobre cualquier disputa no sujeta a arbitraje. Los consumidores domiciliados en la UE, EEE, Reino Unido o Suiza pueden entablar procesos en los tribunales de su país de domicilio y solo podrán ser demandados por nosotros en esos mismos tribunales, conforme al Reglamento Bruselas I-bis (Reglamento (UE) 1215/2012), al Convenio de Lugano y a los equivalentes mantenidos por el Reino Unido.",
          "Control de exportaciones y sanciones: aceptas cumplir con todas las leyes aplicables de control de exportaciones, sanciones y prevención del lavado de dinero, incluidas las de Estados Unidos (OFAC), la Unión Europea, el Reino Unido (OFSI) y las Naciones Unidas, y declaras que no te encuentras en, no resides ordinariamente en, no eres propiedad o estás controlado por, ni estás sujeto a sanciones integrales; que no figuras en ninguna lista de partes restringidas; y que no usarás el servicio para facilitar transacciones prohibidas por dichas leyes.",
        ]},
        { heading: "17. Derechos del consumidor UE / Reino Unido, mecanismo de notificación y acción del DSA y vías de marcadores de confianza", items: [
          "Protecciones imperativas del consumidor (UE/EEE/Reino Unido): nada en estos Términos limita los derechos imperativos que tienes como consumidor bajo la Directiva (UE) 2011/83 sobre derechos de los consumidores, la Directiva (UE) 2019/770 sobre contenidos y servicios digitales, la Directiva 93/13/CEE sobre cláusulas abusivas, la Consumer Rights Act 2015 del Reino Unido y las normas nacionales equivalentes. Cuando una disposición de estos Términos entre en conflicto con dichos derechos imperativos, esa disposición se interpretará de la forma más restringida posible y prevalecerán los derechos imperativos.",
          "Derecho de desistimiento (14 días): los consumidores de la UE/EEE/Reino Unido tienen un derecho de desistimiento de 14 días respecto de los contratos de servicios digitales. Como el servicio comienza inmediatamente tras la compra, se te pide reconocer expresamente que el servicio digital se inicia de inmediato y que pierdes el derecho de desistimiento sobre la parte ya consumida (mensajes enviados, contactos iniciados, regalos entregados, créditos gastados, verificación realizada). Los detalles completos figuran en la Política de Reembolsos.",
          "Declaración de motivos (Art. 17 DSA): cuando restringimos la visibilidad, degradamos, suspendemos o cancelamos un contenido específico tuyo, tu monetización, tu cuenta o tu acceso a funciones específicas, te facilitaremos, cuando lo exija el artículo 17 del Reglamento (UE) 2022/2065 (Ley de Servicios Digitales, 'DSA'), una declaración de motivos clara y específica, incluyendo los hechos y circunstancias en que se basa, los medios automatizados empleados en su caso, la base legal o contractual y las opciones de recurso disponibles.",
          "Mecanismo de notificación y acción (Art. 16 DSA): cualquier persona o entidad puede notificarnos contenidos disponibles en el servicio que considere ilegales conforme al Derecho de la UE o nacional, escribiendo a dsa-notice@matchvenezuelan.com. Para que podamos actuar diligentemente, tu notificación debe incluir: (i) una explicación suficientemente fundamentada de por qué consideras ilegal el contenido; (ii) la indicación clara de la ubicación electrónica exacta (URL/perfil/ID del mensaje); (iii) tu nombre y correo (excepto cuando se trate de los delitos referidos en los artículos 3 a 7 de la Directiva 2011/93, en cuyo caso se preserva el anonimato); y (iv) una declaración de que la información de la notificación es, según tu mejor entender, exacta y completa. Acusaremos recibo sin demora indebida y te informaremos de nuestra decisión y de los recursos disponibles.",
          "Sistema interno de tramitación de reclamaciones (Art. 20 DSA): si no estás de acuerdo con una decisión de moderación que afecte a tu contenido, cuenta, monetización o acceso (o con nuestra decisión sobre una notificación que hayas presentado), puedes presentar una apelación interna gratuita en un plazo de seis (6) meses desde la decisión escribiendo a appeals@matchvenezuelan.com. Una persona distinta de la que tomó la decisión inicial revisará tu apelación y procuraremos resolver en un plazo razonable.",
          "Resolución extrajudicial de litigios (Art. 21 DSA): los destinatarios del servicio en la UE pueden, además, recurrir a cualquier organismo de resolución extrajudicial de litigios certificado por el Coordinador de Servicios Digitales de su Estado miembro para resolver disputas relativas a nuestras decisiones de moderación. Acudir a tales organismos no afecta a tu derecho a iniciar procedimientos judiciales en cualquier momento.",
          "Marcadores de confianza (Art. 22 DSA): las notificaciones presentadas por entidades a las que el Coordinador de Servicios Digitales de su Estado miembro haya otorgado el estatus de 'marcador de confianza' se tramitarán y resolverán con prioridad y sin demora indebida.",
          "Resolución de Litigios en Línea (UE): los consumidores de la UE pueden usar la plataforma ODR de la Comisión Europea en https://ec.europa.eu/consumers/odr para intentar la resolución extrajudicial de disputas sobre servicios en línea. Nuestro correo de contacto a efectos de ODR es legal@matchvenezuelan.com.",
          "Recursos en el Reino Unido: los consumidores del Reino Unido conservan los derechos de la Consumer Rights Act 2015, pueden presentar reclamaciones ante la Competition and Markets Authority (CMA) cuando proceda y pueden recurrir a proveedores aprobados de Resolución Alternativa de Disputas (ADR); nada en estos Términos elimina los recursos legales previstos por la legislación británica.",
          "Punto único de contacto y representante legal: conforme a los artículos 11, 12 y 13 del DSA, mantenemos un punto único de contacto para autoridades y destinatarios del servicio en dsa-contact@matchvenezuelan.com (idiomas de trabajo: inglés y español). Si no estamos establecidos en la UE, nuestro representante legal designado en la UE a efectos del DSA se identificará en esta página una vez nombrado.",
          "Transparencia: publicamos, en la medida y forma exigidas, información de transparencia sobre nuestras actividades de moderación de contenidos (volúmenes de notificaciones recibidas, acciones adoptadas, tiempos medios de respuesta, uso de herramientas automatizadas y revisión humana).",
        ]},
        { heading: "18. Fuerza mayor", items: [
        ...
        { heading: "19. Modificación del servicio y de estos Términos", items: [
        ...
        { heading: "20. Cesión, divisibilidad, acuerdo íntegro, no renuncia", items: [
        ...
        { heading: "21. Contacto", items: [
          "Legal general: legal@matchvenezuelan.com · Contacto DSA / punto único de contacto: dsa-contact@matchvenezuelan.com · Notificaciones DSA: dsa-notice@matchvenezuelan.com · Apelaciones: appeals@matchvenezuelan.com · Privacidad: privacy@matchvenezuelan.com · Confianza y seguridad: trust@matchvenezuelan.com · Copyright/DMCA: copyright@matchvenezuelan.com · Seguridad: security@matchvenezuelan.com.",
        ]},
      ],
      privacySections: [
